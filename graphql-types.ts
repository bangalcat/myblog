...
export type FileFieldsEnum = 
  ...
  'childMarkdownRemark___frontmatter___public' |
...
export type BlogIndexQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: { edges: Array<{ node: (
        ...
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'createdDate' | 'title' | 'description'>> }
      ) }> } };
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'createdDate' | 'updatedDate' | 'description'>> }
  )> };

export type TemplateTagPageQueryVariables = {
  tag?: Maybe<Scalars['String']>;
};


export type TemplateTagPageQuery = { tags: { group: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> }, posts: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt' | 'timeToRead'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'updatedDate'>> }
      ) }> }
  ) };
